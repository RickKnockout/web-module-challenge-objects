...
const coffee = createMenuItem('Coffee', 1, 'Breakfast');
const milk = createMenuItem('Milk', 5, 'Breakfast');
const orangeJuice = createMenuItem('OJ', 3, 'Breakfast');
console.log(coffee);
console.log(milk);
